...
public class JalaliCalendarClass extends Calendar {
    ...
    public JalaliCalendarClass() {
        this(TimeZone.getDefault(), Locale.getDefault());
    }

    public JalaliCalendarClass(TimeZone zone) {
        this(zone, Locale.getDefault());
    }

    public JalaliCalendarClass(Locale aLocale) {
        this(TimeZone.getDefault(), aLocale);
    }

    public JalaliCalendarClass(TimeZone zone, Locale aLocale) {
    ...
    public JalaliCalendarClass(int year, int month, int dayOfMonth) {
        this(year, month, dayOfMonth, 0, 0, 0, 0);
    }

    public JalaliCalendarClass(int year, int month, int dayOfMonth, int hourOfDay,
                               int minute) {
    ...
    JalaliCalendarClass(int year, int month, int dayOfMonth, int hourOfDay,
    ...
    public static int weekOfYear(int dayOfYear, int year) {
        switch (dayOfWeek(JalaliCalendarClass.jalaliToGregorian(new YearMonthDate(
                year, 0, 1)))) {
            case 2:
                dayOfYear++;
                break;
